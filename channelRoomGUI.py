...
def main(threadName, args):
    ...
    enterPressed = 0
    textBox1 = textBox.TextBox((1 * screen_width) / 32, (4 * screen_height) / 5 + 10 + 40, 800, 100, '',
                               (255, 255, 255), (23, 128, 0), '')
    ...
    while 1 == 1:
        ...
        if disconnectPressed == 0:
            disconnectPressed = disconnectButton.updateButtonAndCheckIfPressed(mx, my, mouseJustPressed,
                                                                               mouseJustRelease)
